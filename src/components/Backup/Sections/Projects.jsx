        ...
        >
            <div className="max-w-5xl mx-auto px-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div
                        className="p-6 rounded-xl border border-white/10 hover:-translate-y-1 hover:border-blue-600/30 
                    ...
                    ">
                        ...
                        <div className="flex justify-between items-center">
                            ...
                            <a href="https://github.com/SakethKanchi/Multiple_Disease_Prediction">{<FaGithub />}</a>
                        </div>
                    </div>
                    ...
                    ">
                        ...
                        <div className="flex justify-between items-center">
                            ...
                            <a href="https://github.com/SakethKanchi/Movies_App">{<FaGithub />}</a>
                        </div>
                    </div>
                    ...
                    <div
                        ...
                        hover:shadow-[0_2px_8px_rgba(59,130,246,0.2)] transition
                    ">
                        <h3 className="text-xl font-bold mb-2">Finance Tracking CLI</h3>
                        <p className="text-gray-400 mb-4">
                        ...
                        <div className="flex justify-between items-center">
                            ...
                            <a href="https://github.com/SakethKanchi/Finance_Tracking">{<FaGithub />}</a>
                        </div>
                    </div>
                    ...
                    <div
                        ...
                        hover:shadow-[0_2px_8px_rgba(59,130,246,0.2)] transition
                    ">
                        <h3 className="text-xl font-bold mb-2">Kitty</h3>
                        <p className="text-gray-400 mb-4">
                        ...
                        <div className="flex justify-between items-center">
                            ...
                            <a href="https://marketplace.visualstudio.com/items?itemName=SakethKanchi.kitty-vscode-theme">{<FaGithub />}</a>
                        </div>
                    </div>
